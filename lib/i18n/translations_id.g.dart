...
class _TranslationsBrandId extends TranslationsBrandEn {
	...
	@override String get navigating_to_stats => 'Menavigasi ke statistik untuk {brandName}';
	@override String get navigating_to_invitations => 'Menavigasi ke undangan untuk {brandName}';
	@override String get navigating_to_transfer => 'Menavigasi ke transfer untuk {brandName}';
	@override String get loading_brand_details => 'Memuat detail brand...';
	@override String get brand_name_hint => 'Masukkan nama brand';
	@override String get slug_hint => 'URL-friendly identifier';
	@override String get description_hint => 'Deskripsi singkat brand (opsional)';
	@override String get industry_hint => 'Industri brand (opsional)';
	@override String get new_owner_email_hint => 'Masukkan email pemilik baru';
	@override String get confirmation_code_hint => 'Masukkan kode konfirmasi';
	@override String get email_example => 'contoh: user@example.com';
	@override String get message_hint => 'Pesan untuk pemilik baru';
	@override String get message_explanation => 'Tambahkan pesan penjelasan jika diperlukan';
	@override String get user_email_hint => 'Masukkan email pengguna yang ingin diundang';
	@override String get user_email_example => 'contoh: user@example.com';
	@override String get personal_message_hint => 'Pesan personal untuk pengguna (opsional)';
	@override String get personal_message_explanation => 'Tambahkan pesan personal jika diperlukan';
	@override String get select_role_hint => 'Pilih peran';
	@override String get business_type_service => 'Layanan';
	@override String get business_type_retail => 'Ritel';
	@override String get business_type_manufacturing => 'Manufaktur';
	@override String get business_type_other => 'Lainnya';
	@override String get subscription_tier_basic => 'Dasar';
	@override String get subscription_tier_pro => 'Pro';
	@override String get subscription_tier_enterprise => 'Enterprise';
	@override String get subscription_status_active => 'Aktif';
	@override String get subscription_status_inactive => 'Tidak Aktif';
	@override String get subscription_status_suspended => 'Ditangguhkan';
	@override String get subscription_status_cancelled => 'Dibatalkan';
	@override String get role_owner => 'Pemilik';
	@override String get role_admin => 'Admin';
	@override String get role_manager => 'Manajer';
	@override String get role_employee => 'Karyawan';
	@override String get email_label => 'Email';
	@override String get confirmation_code_label => 'Kode Konfirmasi';
	@override String get six_digit_code_label => 'Kode 6 digit';
	@override String get user_email_label => 'Email Pengguna';
	@override String get user_role_label => 'Peran Pengguna';
	@override String get optional_label => '(Opsional)';
	@override String get back_button => 'Kembali';
	@override String get refresh_button => 'Refresh';
	@override String get edit_button => 'Edit';
	@override String get delete_button => 'Hapus';
	@override String get close_button => 'Tutup';
	@override String get cancel_button => 'Batal';
	@override String get accept_button => 'Terima';
	@override String get decline_button => 'Tolak';
	@override String get resend_button => 'Kirim Ulang';
	@override String get brand_details_title => 'Detail Brand';
	@override String get invitation_details_title => 'Detail Undangan';
	@override String get confirm_edit_brand => 'Apakah Anda ingin mengedit brand ini?';
	@override String get confirm_delete_brand => 'Apakah Anda yakin ingin menghapus brand ini?';
	@override String get confirm_accept_invitation => 'Apakah Anda yakin ingin menerima undangan untuk bergabung dengan {brandName}?';
	@override String get confirm_decline_invitation => 'Apakah Anda yakin ingin menolak undangan dari {brandName}?';
	@override String get confirm_cancel_invitation => 'Apakah Anda yakin ingin membatalkan undangan ke {email}?';
	@override String get new_label => 'BARU';
	@override String get active_label => 'Aktif';
	@override String get created_label => 'Dibuat';
	@override String get joined_label => 'Bergabung: {date}';
	@override String get status_label => 'Status';
	@override String get total_users_label => 'Total Pengguna';
	@override String get active_branches_label => 'Cabang Aktif';
	@override String get monthly_revenue_label => 'Pendapatan Bulanan';
	@override String get growth_label => 'Pertumbuhan';
	@override String get invitations_sent_label => 'Undangan Terkirim';
	@override String get weekly_activity_label => 'Aktivitas Mingguan';
	@override String get performance_score_label => 'Skor Kinerja';
	@override String get active_users_label => 'Aktif: {count}';
	@override String get total_branches_label => 'Total: {count}';
	@override String get revenue_target_label => 'Target: {amount}';
	@override String get compare_last_month_label => 'Banding bulan lalu';
	@override String get pending_invitations_label => '{pending} tertunda, {accepted} diterima';
	@override String get daily_average_label => 'Rata-rata: {count}/hari';
	@override String get very_good_label => 'Sangat Baik';
	@override String get search_hint => 'Cari brand...';
	@override String get search_results_label => 'Hasil Pencarian';
	@override String get type_label => 'Tipe';
	@override String get all_label => 'Semua';
	@override String get no_brands_available_label => 'Tidak ada brand tersedia';
	@override String get no_brands_message_label => 'Buat brand pertama untuk memulai bisnis Anda';
	@override String get create_new_brand_label => 'Buat Brand Baru';
	@override String get statistics_label => 'Statistik';
	@override String get invitations_label => 'Undangan';
	@override String get transfer_label => 'Transfer';
	@override String get view_statistics_label => 'Lihat Statistik';
	@override String get manage_invitations_label => 'Kelola Undangan';
	@override String get transfer_brand_label => 'Transfer Brand';
	@override String get received_label => 'Diterima';
	@override String get no_received_invitations_label => 'Tidak ada undangan yang diterima';
	@override String get no_sent_invitations_label => 'Tidak ada undangan terkirim';
	@override String get failed_to_load_invitations_label => 'Gagal memuat undangan';
	@override String get failed_to_load_received_invitations_label => 'Terjadi kesalahan saat memuat undangan yang diterima. Silakan coba lagi.';
	@override String get failed_to_load_sent_invitations_label => 'Terjadi kesalahan saat memuat undangan terkirim. Silakan coba lagi.';
	@override String get invitation_details_label => 'Detail Undangan';
	@override String get invite_new_user_label => 'Undang Pengguna Baru';
	@override String get pending_label => 'Pending';
	@override String get accepted_label => 'Diterima';
	@override String get declined_label => 'Ditolak';
	@override String get expired_label => 'Kadaluarsa';
	@override String get brand_owner_label => 'Pemilik Brand';
	@override String get brand_admin_label => 'Admin Brand';
	@override String get branch_manager_label => 'Manajer Cabang';
	@override String get branch_admin_label => 'Admin Cabang';
	@override String get branch_staff_label => 'Staf Cabang';
	@override String get cross_branch_viewer_label => 'Penonton Lintas Cabang';
	@override String get transfer_ownership_warning_label => 'Peringatan Transfer Kepemilikanan';
	@override String get transfer_warning_message_label => 'Tindakan ini tidak dapat dibatalkan dan akan mengubah kepemilikanan brand secara permanen. Pastikan Anda memasukkan email yang benar dan pemilik baru telah menyetujui transfer ini.';
	@override String get new_owner_email_label => 'Email Pemilik Baru';
	@override String get message_optional_label => 'Pesan (Opsional)';
	@override String get message_for_new_owner_label => 'Pesan untuk pemilik baru';
	@override String get add_explanation_message_label => 'Tambahkan pesan penjelasan jika diperlukan';
	@override String get detail_transfer_label => 'Detail Transfer';
	@override String get no_brands_available_selector_label => 'Tidak ada brand tersedia';
	@override String get select_brand_label => 'Pilih Brand';
	@override String get currently_label => 'Saat ini:';
	@override String get brand_switched_success => 'Beralih ke {brandName}';
	@override String get user_invited_success => 'Pengguna berhasil diundang';
	@override String get invitation_accepted_success => 'Undangan berhasil diterima';
	@override String get invitation_declined_success => 'Undangan ditolak';
	@override String get brand_found_success => 'Brand ditemukan: {brandName}';
	@override String get invitations_loaded_success => '{count} undangan dimuat';
	@override String get ownership_transferred_success => 'Kepemilikanan berhasil ditransfer';
	@override String get invitation_cancelled_success => 'Undangan dibatalkan';
	@override String get invitation_resent_success => 'Undangan dikirim ulang';
	@override String get failed_to_load_brands => 'Gagal memuat brands';
	@override String get brand_creation_failed => 'Pembuatan brand gagal';
	@override String get brand_update_failed => 'Pembaruan brand gagal';
	@override String get brand_deletion_failed => 'Penghapusan brand gagal';
	@override String get invitation_send_failed => 'Gagal mengirim undangan';
	@override String get transfer_failed => 'Transfer kepemilikanan gagal';
	@override String get month_jan => 'Jan';
	@override String get month_feb => 'Feb';
	@override String get month_mar => 'Mar';
	@override String get month_apr => 'Apr';
	@override String get month_may => 'Mei';
	@override String get month_jun => 'Jun';
	@override String get month_jul => 'Jul';
	@override String get month_aug => 'Agu';
	@override String get month_sep => 'Sep';
	@override String get month_oct => 'Okt';
	@override String get month_nov => 'Nov';
	@override String get month_des => 'Des';
	@override String get increase_label => 'kenaikan';
	@override String get decrease_label => 'penurunan';
	@override String get percent_change => '{sign}{percent}%';
	@override String get edit_brand_description => 'Perbarui data brand yang ada sesuai kebutuhan';
	@override String get create_brand_description => 'Lengkapi data brand Anda dan mulai beroperasi';
	@override String get brand_info_description => 'Perbarui informasi brand di bawah ini. Pastikan semua data yang diperlukan sudah benar.';
	@override String get back_tooltip => 'Kembali';
	@override String get refresh_tooltip => 'Refresh';
	@override String get enable_manual_slug_tooltip => 'Enable manual slug input';
}
